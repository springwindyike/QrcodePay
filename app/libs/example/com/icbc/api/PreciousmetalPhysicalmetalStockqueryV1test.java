...
import com.icbc.api.request.PreciousmetalPhysicalmetalStockqueryRequestV1;
import com.icbc.api.request.PreciousmetalPhysicalmetalStockqueryRequestV1.PreciousmetalPhysicalmetalStockqueryRequestV1Biz;
import com.icbc.api.response.PreciousmetalPhysicalmetalStockqueryResponseV1;

public class PreciousmetalPhysicalmetalStockqueryV1test {
	...
	public void test_cop() throws IcbcApiException {
		...
		PreciousmetalPhysicalmetalStockqueryRequestV1 request = new PreciousmetalPhysicalmetalStockqueryRequestV1();
		request.setServiceUrl("http://122.19.77.226:8081/api/preciousmetal/physicalmetal/V1/stockquery");

		PreciousmetalPhysicalmetalStockqueryRequestV1Biz bizContent = new PreciousmetalPhysicalmetalStockqueryRequestV1Biz();
		bizContent.setTrxSeqNo("123456");
		bizContent.setTrxTs("2017-04-07 17:15:12.762126");
		List<Integer> phyPptxnnoList = new ArrayList<Integer>();
		phyPptxnnoList.add(10020);
		phyPptxnnoList.add(10100);
		bizContent.setPhyPptxnnoList(phyPptxnnoList);
	    
		request.setBizContent(bizContent);

		PreciousmetalPhysicalmetalStockqueryResponseV1 response = client.execute(request, "msgId");
