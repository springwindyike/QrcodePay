...
import com.icbc.api.request.MybankLoanOrdercancellationRequestV1;
import com.icbc.api.response.MybankLoanOrdercancellationResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanOrdercancellationTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanOrdercancellationRequestV1 request = new MybankLoanOrdercancellationRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanOrdercancellationRequestV1.MybankLoanOrdercancellationRequestV1Biz bizContent = new MybankLoanOrdercancellationRequestV1.MybankLoanOrdercancellationRequestV1Biz();

        //8、组装请求参数.
        JSONArray subInput = new JSONArray();
        JSONObject data1 = new JSONObject();
        data1.put("orderNo", "1111");
        data1.put("remark1", "");
        data1.put("remark2", "");
        data1.put("remark3", "");
        subInput.add(data1);
        ...
        //MybankLoanOrdercancellationResponseV1 response;
        try {
            //response =
