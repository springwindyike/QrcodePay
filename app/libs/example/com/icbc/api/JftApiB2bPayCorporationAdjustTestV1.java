...
public class JftApiB2bPayCorporationAdjustTestV1 {
    ...
    public static void main(String[] args) {
        ...
        request.setServiceUrl("http://122.64.61.194:8081/api/jft/api/b2bpay/coperation/adjust/V1");
        ...
        try {
            response =(JftApiB2bPayCorporationAdjustResponseV1) client.execute(request, System.currentTimeMillis()+"");//msgId消息通讯唯一编号，要求每次调用独立生成，APP级唯一
