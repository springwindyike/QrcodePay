...
import com.icbc.api.request.PreciousmetalParameterQuotaqueryRequestV1;
import com.icbc.api.request.PreciousmetalParameterQuotaqueryRequestV1.PreciousmetalParameterQuotaqueryRequestV1Biz;
import com.icbc.api.response.PreciousmetalParameterQuotaqueryResponseV1;

public class PreciousmetalParameterQuotaqueryV1test {
	...
	public void test_cop() throws IcbcApiException {
		...
		PreciousmetalParameterQuotaqueryRequestV1 request = new PreciousmetalParameterQuotaqueryRequestV1();
		request.setServiceUrl("http://122.19.77.226:8081/api/preciousmetal/parameter/V1/quotaquery");

		PreciousmetalParameterQuotaqueryRequestV1Biz bizContent = new PreciousmetalParameterQuotaqueryRequestV1Biz();
		bizContent.setTrxSeqNo("123456");
		bizContent.setTrxTs("2017-04-07 17:15:12.762126");
		bizContent.setValidDate("2017-04-07");
	    
		request.setBizContent(bizContent);

		PreciousmetalParameterQuotaqueryResponseV1 response = client.execute(request, "msgId");
