...
public class MybankAccountBankconfirmationrequestBcrrequestmakeV1Test {
	...
	public void test() throws Exception {
		...
		request.setServiceUrl("http://122.64.109.110:8081/api/mybank/account/bankconfirmationrequest/bcrrequestmake/V1");
		...
		bizContent.setAuthPayAccount("0200062009213110737");// 授权付费账号
		bizContent.setOrganizationName("na m e2");// 被函证单位名称
		bizContent.setSubmitter("111");// 函证单位提交人
		bizContent.setIpAddress("122.2.2.2");// IP
		...
		for (int i = 0; i < 1; i++) {
			...
			conlist.setConditionNO("0200062009213110737");
