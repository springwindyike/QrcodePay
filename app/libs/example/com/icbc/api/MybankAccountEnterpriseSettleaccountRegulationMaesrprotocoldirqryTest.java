...
import com.icbc.api.request.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestV1;
import com.icbc.api.request.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestV1.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestBizV1;
import com.icbc.api.response.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryResponseV1;

public class MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryTest {
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/account/enterprise/settleaccount/regulation/maesrprotocoldirqry/V1";
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY, APIGW_PUBLIC_KEY);
        try {
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestBizV1 bizContent =
                    new MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestBizV1();
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestV1 request = new MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryRequestV1();
            // 请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
            bizContent.setfSeqNo("123");
            request.setServiceUrl(BASE_URL + "/" + URI);
            request.setBizContent(bizContent);
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocoldirqryResponseV1 response = client.execute(request);
