...
import com.icbc.api.request.MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequestV1.MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequesBizV1;
import com.icbc.api.response.MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitResponseV1;

/**
 * 推广版-高级批量扣个人缴费协议导入提交接口
 * 
 * @author kfzx-yinfc
 *
 */
...
public class MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitTest {
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequesBizV1 bizContent =
                    new MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequesBizV1();
            MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequestV1 request =
                    new MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequestV1();
            ...
            bizContent.setTotalNum(0);

            bizContent.setContractNo("");
            bizContent.setPayType("");
            bizContent.setAcctName("");
            bizContent.setAcctNo("");
            bizContent.setReqReserved1("");
            bizContent.setReqReserved2("");
            // List<MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitRequestV1RdV1> rd;
            // bizContent.setRd(rd);

            request.setServiceUrl(BASE_URL + "/" + URI);
            request.setBizContent(bizContent);
            MybankEnterprisePayBatchpersonaldeductMepbprotocolsubmitResponseV1 response =
