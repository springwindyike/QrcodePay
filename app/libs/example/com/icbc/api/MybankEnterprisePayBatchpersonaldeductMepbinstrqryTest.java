...
public class MybankEnterprisePayBatchpersonaldeductMepbinstrqryTest {
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/enterprise/pay/batchpersonaldeduct/mepbinstrqry/V1"; // api地址
        ...
        try {
            ...
            // 输出响应对象，需根据实际调用服务更换（MybankEnterprisePayBatchpersonaldeductMepbinstrqryResponseV1）
