...
import com.icbc.api.request.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestV1;
import com.icbc.api.request.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestV1.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestBizV1;
import com.icbc.api.response.MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryResponseV1;

public class MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryTest {
    ...
    public static void main(String[] args) throws Exception {
        String URI = "mybank/account/enterprise/settleaccount/regulation/maesrprotocolqry/V1";
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, PRI_KEY, APIGW_PUBLIC_KEY);
        try {
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestBizV1 bizContent =
                    new MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestBizV1();
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestV1 request = new MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryRequestV1();
            // 请对照接口文档用bizContent.setxxx()方法对业务上送数据进行赋值
            bizContent.setfSeqNo("123");
            request.setServiceUrl(BASE_URL + "/" + URI);
            request.setBizContent(bizContent);
            MybankAccountEnterpriseSettleaccountRegulationMaesrprotocolqryResponseV1 response = client.execute(request);
