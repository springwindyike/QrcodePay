...
import com.icbc.api.request.MybankLoanOrderapplicationRequestV1;
import com.icbc.api.response.MybankLoanOrderapplicationResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanOrderapplicationTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanOrderapplicationRequestV1 request = new MybankLoanOrderapplicationRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz bizContent = new MybankLoanOrderapplicationRequestV1.MybankLoanOrderapplicationRequestV1Biz();

        //8、组装请求参数.
        JSONArray subInput = new JSONArray();
        JSONObject data1 = new JSONObject();
        data1.put("orderNo", "CS1911141448DJ21W");
        data1.put("orderAmt", "800");
        data1.put("orderAdvAmt", "500");
        data1.put("loanAmt", "300");
        data1.put("orderTerm", "12");
        data1.put("loanTerm", "12");
        data1.put("orderDetail", "100");
        subInput.add(data1);
        ...
        //MybankLoanOrderapplicationResponseV1 response;
        try {
            //response =
