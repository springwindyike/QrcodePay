...
public class JftApiPayB2bpayGenpreorderTestV1 {
    ...
    public void test() throws IcbcApiException {
        ...
        DefaultIcbcClient client = new DefaultIcbcClient(APP_ID, IcbcConstants.SIGN_TYPE_RSA, MY_PRIVATE_KEY,IcbcConstants.CHARSET_UTF8,IcbcConstants.FORMAT_JSON,
        ...
        request.setServiceUrl("http://122.64.61.194:8081/api/jft/api/pay/b2bpay/genpreorder/V1");
        ...
        bizContent.setOutOrderId("20181128531215026");
        bizContent.setTradeTime("2019-05-06 11:11:11");
