...
import com.icbc.api.request.InsuranceCustprtlProtocolQueryOrderRequestV1;
import com.icbc.api.response.InsuranceCustprtlProtocolQueryOrderResponseV1;
import java.util.logging.Logger;

public class InsuranceCustprtlProtocolQueryOrderTest {

    static Logger log = Logger.getLogger(InsuranceCustprtlProtocolQueryOrderTest.class.getName());
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // 请求实体
            InsuranceCustprtlProtocolQueryOrderRequestV1 request = new InsuranceCustprtlProtocolQueryOrderRequestV1();
            // bizContent实体
            InsuranceCustprtlProtocolQueryOrderRequestV1.ApiInvestmentInsuranceCustprtlProtocolQueryOrderRequestV1Biz bizContent
                    = new InsuranceCustprtlProtocolQueryOrderRequestV1.ApiInvestmentInsuranceCustprtlProtocolQueryOrderRequestV1Biz();
            InsuranceCustprtlProtocolQueryOrderRequestV1.CommonReqInfo commonReqInfoContent
                    = new InsuranceCustprtlProtocolQueryOrderRequestV1.CommonReqInfo();
            InsuranceCustprtlProtocolQueryOrderRequestV1.TransReqInfo transReqInfoContent
                    = new InsuranceCustprtlProtocolQueryOrderRequestV1.TransReqInfo();
            InsuranceCustprtlProtocolQueryOrderRequestV1.BizContentInfo bizContentInfo =
                    new InsuranceCustprtlProtocolQueryOrderRequestV1.BizContentInfo();
...
//					System.out.println(instBean.getReportkind());
            InsuranceCustprtlProtocolQueryOrderResponseV1 response = client.execute(request);
