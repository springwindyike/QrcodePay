...
import com.icbc.api.request.InsuranceCustprtlProtocolConfirmRequestV1;
import com.icbc.api.response.InsuranceCustprtlProtocolConfirmResponseV1;
import java.util.logging.Logger;

public class InsuranceCustprtlProtocolConfirmTest {
    static Logger log = Logger.getLogger(InsuranceCustprtlProtocolConfirmTest.class.getName());
    //估值表
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // 请求实体
            InsuranceCustprtlProtocolConfirmRequestV1 request = new InsuranceCustprtlProtocolConfirmRequestV1();
            // bizContent实体
            InsuranceCustprtlProtocolConfirmRequestV1.ApiInvestmentInsuranceCustprtlProtocolConfirmRequestV1Biz bizContent
                    = new InsuranceCustprtlProtocolConfirmRequestV1.ApiInvestmentInsuranceCustprtlProtocolConfirmRequestV1Biz();
            InsuranceCustprtlProtocolConfirmRequestV1.CommonReqInfo commonReqInfoContent
                    = new InsuranceCustprtlProtocolConfirmRequestV1.CommonReqInfo();
            InsuranceCustprtlProtocolConfirmRequestV1.TransReqInfo transReqInfoContent
                    = new InsuranceCustprtlProtocolConfirmRequestV1.TransReqInfo();
            InsuranceCustprtlProtocolConfirmRequestV1.BizContentInfo bizContentInfo =
                    new InsuranceCustprtlProtocolConfirmRequestV1.BizContentInfo();
           ...
           InsuranceCustprtlProtocolConfirmResponseV1 response = client.execute(request);
