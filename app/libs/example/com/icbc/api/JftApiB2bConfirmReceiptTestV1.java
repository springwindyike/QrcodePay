...
public class JftApiB2bConfirmReceiptTestV1 {
    ...
    public static void main(String[] args) {
        ...
        request.setServiceUrl("http://83.36.2.118:8081/api/jft/api/pay/b2bpay/b2bconfirmreceipt/V1");
        ...
        bizContent.setOutOrderId("12345678901234567890");//平台订单ID
        bizContent.setOutUserId("71810240115");//用户编号
