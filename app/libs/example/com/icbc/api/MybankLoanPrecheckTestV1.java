...
import com.icbc.api.request.MybankLoanPrecheckRequestV1;
import com.icbc.api.response.MybankLoanPrecheckResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanPrecheckTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanPrecheckRequestV1 request = new MybankLoanPrecheckRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanPrecheckRequestV1.MybankLoanPrecheckRequestV1Biz bizContent = new MybankLoanPrecheckRequestV1.MybankLoanPrecheckRequestV1Biz();
        ...
        //MybankLoanPrecheckResponseV1 response;
        try {
            //response =
