...
import com.icbc.api.request.InsuranceCustprtlProtocolModifyRequestV1;
import com.icbc.api.response.InsuranceCustprtlProtocolModifyResponseV1;
import java.util.logging.Logger;

public class InsuranceCustprtlProtocolModifyTest {
    static Logger log = Logger.getLogger(InsuranceCustprtlProtocolModifyTest.class.getName());
    //估值表
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            ...
            // 请求实体
            InsuranceCustprtlProtocolModifyRequestV1 request = new InsuranceCustprtlProtocolModifyRequestV1();
            // bizContent实体
            InsuranceCustprtlProtocolModifyRequestV1.ApiInvestmentInsuranceCustprtlProtocolModifyRequestV1Biz bizContent
                    = new InsuranceCustprtlProtocolModifyRequestV1.ApiInvestmentInsuranceCustprtlProtocolModifyRequestV1Biz();
            InsuranceCustprtlProtocolModifyRequestV1.CommonReqInfo commonReqInfoContent
                    = new InsuranceCustprtlProtocolModifyRequestV1.CommonReqInfo();
            InsuranceCustprtlProtocolModifyRequestV1.TransReqInfo transReqInfoContent
                    = new InsuranceCustprtlProtocolModifyRequestV1.TransReqInfo();
            InsuranceCustprtlProtocolModifyRequestV1.BizContentInfo bizContentInfo =
                    new InsuranceCustprtlProtocolModifyRequestV1.BizContentInfo();
            ...
            InsuranceCustprtlProtocolModifyResponseV1 response = client.execute(request);
