...
import com.icbc.api.request.MybankLoanLoanlimitRequestV1;
import com.icbc.api.response.MybankLoanLoanlimitResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanLoanlimitTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanLoanlimitRequestV1 request = new MybankLoanLoanlimitRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanLoanlimitRequestV1.MybankLoanLoanlimitRequestV1Biz bizContent = new MybankLoanLoanlimitRequestV1.MybankLoanLoanlimitRequestV1Biz();
        ...
        //MybankLoanLoanlimitResponseV1 response;
        try {
