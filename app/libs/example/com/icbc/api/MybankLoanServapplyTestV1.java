...
import com.icbc.api.request.MybankLoanServapplyRequestV1;
import com.icbc.api.response.MybankLoanServapplyResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanServapplyTestV1 {
    public static void main(String[] args) {
        ...
        String APP_ID = "xxxx";
                //"10000000000004114431";10000000000004096747
        //3、网关公钥
        ...
        //5、设置请求对象
        MybankLoanServapplyRequestV1 request = new MybankLoanServapplyRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanServapplyRequestV1.MybankLoanServapplyRequestV1Biz bizContent = new MybankLoanServapplyRequestV1.MybankLoanServapplyRequestV1Biz();
        ...
        bizContent.setEmail("shenkezhi@test.com");
        ...
        //MybankLoanServapplyResponseV1 response;
        try {
            //response =
