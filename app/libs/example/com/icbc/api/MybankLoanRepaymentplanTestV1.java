...
import com.icbc.api.request.MybankLoanRepaymentplanRequestV1;
import com.icbc.api.response.MybankLoanRepaymentplanResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanRepaymentplanTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanRepaymentplanRequestV1 request = new MybankLoanRepaymentplanRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanRepaymentplanRequestV1.MybankLoanRepaymentplanRequestV1Biz bizContent = new MybankLoanRepaymentplanRequestV1.MybankLoanRepaymentplanRequestV1Biz();
        ...
        //MybankLoanRepaymentplanResponseV1 response;
        try {
