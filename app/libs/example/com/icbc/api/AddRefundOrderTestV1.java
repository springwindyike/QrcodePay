...
public class AddRefundOrderTestV1 {
	...
	public static void main(String[] args) {
		...
		//request.setServiceUrl("http://122.20.173.105:8081/api/cfjs/api/pay/add/refund/order/V1");
		request.setServiceUrl("http://122.20.173.105:8081/api/jft/api/pay/add/refund/order/V1");
