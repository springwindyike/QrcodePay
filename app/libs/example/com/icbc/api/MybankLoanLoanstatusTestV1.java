...
import com.icbc.api.request.MybankLoanLoanstatusRequestV1;
import com.icbc.api.response.MybankLoanLoanstatusResponseV1;
 ...
 * @Date: 2019/11/11
 */
public class MybankLoanLoanstatusTestV1 {
    public static void main(String[] args) {
        ...
        //5、设置请求对象
        MybankLoanLoanstatusRequestV1 request = new MybankLoanLoanstatusRequestV1();
        //6、设置请求路径；联测时，请联系我行告知并替换成测试环境地址。
        request.setServiceUrl("xxxx");
        //7、设置业务参数
        MybankLoanLoanstatusRequestV1.MybankLoanLoanstatusRequestV1Biz bizContent = new MybankLoanLoanstatusRequestV1.MybankLoanLoanstatusRequestV1Biz();

        //8、组装请求参数
        JSONArray subInput = new JSONArray();
        JSONObject data1 = new JSONObject();
        data1.put("CIS", "xxxx");
        data1.put("orderNo", "xxxx");
        data1.put("remark1", "");
        data1.put("remark2", "");
        data1.put("remark3", "");
        ...
        //MybankLoanLoanstatusResponseV1 response;
        try {
